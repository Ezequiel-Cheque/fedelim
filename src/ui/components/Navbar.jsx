            ...
            <div className="div-logo">
                <div className="logo">
                    ...
                    <div className='social-buttons'>
                        <a className="sharing-item sharing-facebook" href="#">
                            <svg className="i i-facebook" viewBox="0 0 24 24">
                                <path d="M17 14h-3v8h-4v-8H7v-4h3V7a5 5 0 0 1 5-5h3v4h-3q-1 0-1 1v3h4Z"></path>
                            </svg>
                        </a>
                        <a className="sharing-item sharing-instagram" href="#">
                        ...
                        <a className="sharing-item sharing-envelope" href="#">
                            <svg className="i i-envelope" viewBox="0 0 24 24">
                                <rect width="20" height="16" x="2" y="4" rx="2"></rect>
                                <path d="m22 8-10 5L2 8"></path>
                            </svg>
                        </a>
                        <a className="sharing-item sharing-whatsapp" href="#">
